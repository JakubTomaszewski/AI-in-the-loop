...
if __name__ == "__main__":
    ...
    # Strategy generation
    strategy_generation_with_history_chain = chain_factory.create_chain(
        ChainType.STRATEGY_GENERATION_WITH_HISTORY, get_chat_history=get_history
    )
    ...
    while iteration_number < args.max_loop_iterations:
        ...
        prompt_generation_strategy = strategy_generation_with_history_chain.invoke(
            {
